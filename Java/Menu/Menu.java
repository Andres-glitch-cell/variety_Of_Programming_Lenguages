    ...
    public static void main(String[] args) {
        ...
        switch (opcion) {
            case 1:
                ...
                if (numeroProductos >= numeroProductosIntroducidos.length) {
            ...
            case 2:
                if (numeroProductos <= 0) {
                    ...
                    System.out.println("Producto creado: " + producto.getNombre() + " " + producto.getPrecioConDecimales()+ " " + producto.getPrecioSinDecimales());
                }
                break;
        }
        sc.close();
